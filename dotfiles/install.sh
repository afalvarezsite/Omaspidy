...
CORE_PKGS=(
    ...
    greetd greetd-tuigreet pulsemixer snapper snap-pac power-profiles-daemon hyprsunset sbctl
...
command = "tuigreet --remember --cmd start-hyprland --asterisks --time --theme 'border=red;text=white;prompt=red;time=white;action=red;button=red;container=black;input=red'"
user = "greeter"
EOF
